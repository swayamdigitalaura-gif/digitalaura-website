...
const EmailWhatsAppModal = ({ open, onClose }: Props) => {
  const s = useSettings(["emailmodal_h2_1", "emailmodal_p_1", "emailmodal_p_2"]);
              ...
              <div className="relative px-8 pt-8 pb-7 overflow-hidden" style={{ background: "linear-gradient(135deg, #0A1628 0%, #1A2744 100%)" }}>
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <h2 className="text-[22px] font-black text-white leading-snug mb-3"><span data-cms-key="emailmodal_h2_1" data-cms-label="Modal Heading" data-cms-attr="text">{s.emailmodal_h2_1 || "Direct Marketing That Drives Repeat Business & Loyalty"}</span></h2>
                    <p className="text-[14px] leading-relaxed" style={{ color: "#94A3B8" }}><span data-cms-key="emailmodal_p_1" data-cms-label="Body Text" data-cms-attr="text">{s.emailmodal_p_1 || "Reach your audience directly with high converting email campaigns and WhatsApp broadcasts, personalised, automated, and built to drive repeat revenue."}</span></p>
                  </div>
                </div>
              </div>
