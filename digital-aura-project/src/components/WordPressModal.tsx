...
import { X, ArrowRight, Check, Zap, Globe2, LayoutTemplate, Plug, Gauge, ShoppingCart, Newspaper, Briefcase, BookOpen, Check as CheckIcon, ShieldCheck, TrendingUp, Smile, Settings } from "lucide-react";
...
const ACCENT = "#21759B"; // WordPress blue
...
const whyUs = [
  ...
  "Secure, regularly updated codebase",
  "Easy CMS for non technical teams",
  "Ongoing support & training included",
];

const techStack = [
  { label: "CMS",        color: "#21759B", bg: "rgba(33,117,155,0.08)",  pills: ["WordPress", "Gutenberg", "ACF"] },
  { label: "Frontend",   color: "#6C47FF", bg: "rgba(108,71,255,0.08)",  pills: ["HTML5", "CSS3", "JavaScript"] },
  { label: "eCommerce",  color: "#96588A", bg: "rgba(150,88,138,0.08)",  pills: ["WooCommerce", "Payment APIs"] },
  { label: "Dev Tools",  color: "#22C55E", bg: "rgba(34,197,94,0.08)",   pills: ["Git", "WPML", "Yoast SEO"] },
];

const builds = [
  { label: "Business Websites",     Icon: Briefcase },
  { label: "Blog & News Portals",   Icon: Newspaper },
  { label: "Landing Pages",         Icon: LayoutTemplate },
  { label: "eCommerce Stores",      Icon: ShoppingCart },
  { label: "Portfolio Sites",       Icon: BookOpen },
  { label: "Membership Platforms",  Icon: Globe2 },
];

const results = [
  { Icon: Gauge,       text: "Fast loading, high performance sites" },
  { Icon: TrendingUp,  text: "Better SEO rankings and organic traffic" },
  { Icon: Settings,    text: "Easy to manage without technical skills" },
  { Icon: ShieldCheck, text: "Secure and regularly maintained websites" },
];

const WordPressModal = ({ open, onClose }: Props) => {
  useEffect(() => {
            ...
            >
              ...
              >
                ...
                <div className="absolute -top-10 -right-10 w-48 h-48 rounded-full opacity-20"
                  style={{ background: "radial-gradient(circle, #21759B, transparent)", filter: "blur(40px)" }} />

                <div className="relative flex items-start gap-4">
                  <div
                    className="w-14 h-14 rounded-xl flex items-center justify-center shrink-0"
                    style={{ background: "rgba(33,117,155,0.2)", border: "1.5px solid rgba(33,117,155,0.4)" }}
                  >
                    <Globe2 size={26} style={{ color: "#7DC4FF" }} />
                  </div>
                  <div>
                    <span className="text-[11px] font-bold uppercase tracking-[0.15em] mb-1.5 block" style={{ color: ACCENT }}>
                      WordPress Development
                    </span>
                    <h2 className="text-[22px] font-black text-white leading-snug mb-3">
                      WordPress Development That Builds<br />Powerful, Scalable Websites
                    </h2>
                    <p className="text-[14px] leading-relaxed" style={{ color: "#94A3B8" }}>
                      Custom WordPress websites built for speed, SEO, and ease of management , 
                      fully tailored to your brand, with clean code and ongoing support.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="px-8 py-7 space-y-8">
                  ...
                  <div className="grid grid-cols-3 gap-2.5">
                    {builds.map(b => (
                      <div key={b.label}
                        ...
                        <b.Icon size={15} style={{ color: ACCENT, flexShrink: 0 }} />
                        {b.label}
                      </div>
                    ))}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  {results.map(r => (
                    <div key={r.text} className="flex items-center gap-3 px-4 py-3.5 rounded-xl"
                      style={{ background: "rgba(33,117,155,0.06)", border: "1px solid rgba(33,117,155,0.15)" }}>
                ...
                <div className="rounded-xl p-6 flex flex-col sm:flex-row items-center gap-4"
                  style={{ background: "linear-gradient(135deg, #0A1628, #1A2744)", border: "1px solid rgba(33,117,155,0.2)" }}>
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      <Zap size={14} style={{ color: ACCENT }} />
                      <span className="text-[11px] font-bold uppercase tracking-wider" style={{ color: ACCENT }}>Ready to Build?</span>
                    </div>
                    <p className="text-[13px] text-[#94A3B8] leading-relaxed">
                      Whether it's a brand new website or a redesign, we build fast, beautiful WordPress sites tailored to your goals.
                    </p>
                  </div>
                  <Link
                    to="/contact"
                  ...
                  >
                    Let's Build Your Website <ArrowRight size={14} />
                  </Link>
                </div>
