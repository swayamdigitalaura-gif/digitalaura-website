...
const AIApiIntegrationPage = () => {
  const sp = useSettings(['aiapi_hero_h1','aiapi_hero_sub','aiapi_cta_btn']);
  return (
  <PageLayout>
    {/* HERO */}
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10 pt-20 pb-14">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.65 }}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black leading-[1.1] text-[#0A1628] mb-5 tracking-tight">
            <span data-cms-key="aiapi_hero_h1" data-cms-label="Hero H1" data-cms-attr="text">{sp.aiapi_hero_h1 || (<>Add AI to Your Product.<br />
          ...
          <p className="text-lg md:text-xl text-[#4B5563] max-w-2xl mx-auto mb-5 leading-relaxed">
            <span data-cms-key="aiapi_hero_sub" data-cms-label="Hero Subtext" data-cms-attr="text">{sp.aiapi_hero_sub || "We embed OpenAI, Gemini, Claude, or custom ML APIs directly into your existing product or website adding powerful AI features without touching your core platform."}</span>
          </p>
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 rounded-full text-sm font-bold text-white transition-all hover:gap-3"
              ...
              <span data-cms-key="aiapi_cta_btn" data-cms-label="CTA Button" data-cms-attr="text">{sp.aiapi_cta_btn || "Integrate AI Into My Product"}</span> <ArrowRight size={16} />
            </Link>
