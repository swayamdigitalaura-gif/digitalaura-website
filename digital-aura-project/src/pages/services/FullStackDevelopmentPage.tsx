    ...
    <section className="py-14 px-4 md:px-8 bg-white" style={{ borderTop: "1px solid #F3F4F6", borderBottom: "1px solid #F3F4F6" }}>
      <div className="max-w-5xl mx-auto">
        ...
        <ClientLogoGrid accentColor={accent} clients={[
          ...
          { name: "Parasher Academy",        tag: "Educational",          logo: "/logos/parasher-academy.png",                                                                           logoBg: "#f5f0ff" },
          ...
          { name: "Dr Ronak Patel",          tag: "Orthopaedic Hospital", logo: "/logos/dr-ronak-patel.webp",                                                                               logoBg: "#f0f7ff" },
