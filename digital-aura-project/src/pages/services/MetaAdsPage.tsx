...
/* ─── Page ─── */
const MetaAdsPage = () => {
  const sp = useSettings(['metaads_hero_h1','metaads_hero_sub','metaads_cta_btn']);
  return (
  <PageLayout>
    {/* ── Hero ── */}
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10 pt-20 pb-8">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[54px] font-black leading-[1.1] text-[#0A1628] mb-5 tracking-tight">
            <span data-cms-key="metaads_hero_h1" data-cms-label="Hero H1" data-cms-attr="text">{sp.metaads_hero_h1 || (<>Reach, Engage & Convert with<br />
          ...
          <p className="text-lg md:text-xl text-[#4B5563] max-w-2xl mx-auto mb-4 leading-relaxed">
            <span data-cms-key="metaads_hero_sub" data-cms-label="Hero Subtext" data-cms-attr="text">{sp.metaads_hero_sub || "We help businesses grow through highly targeted Facebook and Instagram campaigns reaching the right audience, creating scroll stopping creatives, and driving measurable conversions across every stage of the customer journey."}</span>
          </p>
          {/* Badges */}
