      ...
      <div className="max-w-4xl mx-auto px-4 md:px-8 text-center relative z-10 pt-20 pb-8">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-lg md:text-xl text-[#4B5563] max-w-2xl mx-auto mb-4 leading-relaxed">
            Local SEO gets your business found in Google Maps, the local pack, and "near me" searches, through Google Business Profile optimisation, consistent citations, review growth, and geo-targeted landing pages, strategies we detail further on our <Link to="/blog" className="underline" style={{ color: accentColor }}>blog</Link>.
          </p>
