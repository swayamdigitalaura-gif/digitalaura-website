...
import logo from "@/assets/brand/digital-aura-logo.png";
    ...
    items: [
      {
        ...
        desc: "Smart, scalable apps with AI at the core",
        route: `${BASE}/services/ai-powered-web-apps`,
      },
      {
        icon: Brain,
        title: "AI Automation Systems",
        desc: "Intelligent workflows that save hours daily",
        route: `${BASE}/services/ai-automation`,
      },
      {
        icon: Workflow,
        title: "AI Chatbots & Assistants",
        desc: "24/7 conversational AI for leads & support",
        route: `${BASE}/services/ai-chatbot-assistant`,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "High performance, SEO ready websites",
        route: `${BASE}/services/web-app-development`,
      },
      {
        icon: Code2,
        title: "Full Stack Development",
        desc: "End to end apps with robust backends & APIs",
        route: `${BASE}/services/full-stack-development`,
      },
      {
        icon: PenTool,
        title: "WordPress Development",
        desc: "Fast, SEO driven WordPress sites",
        route: `${BASE}/services/wordpress-development`,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        route: `${BASE}/services/shopify-development`,
      },
      {
        icon: Store,
        title: "WooCommerce Development",
        desc: "Flexible WooCommerce with full control",
        route: `${BASE}/services/woocommerce-development`,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Rank on page 1 with technical SEO & content",
        route: `${BASE}/services/seo-content-marketing`,
      },
      {
        icon: Target,
        title: "Google Ads",
        desc: "Data driven Search, Display & Shopping ads",
        route: `${BASE}/services/google-ads`,
      },
      {
        icon: Share2,
        title: "Meta Ads",
        desc: "Facebook & Instagram campaigns that convert",
        route: `${BASE}/services/meta-ads`,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        desc: "Native Kotlin apps for every Android device",
        route: `${BASE}/services/android-development`,
      },
      {
        icon: AppWindow,
        title: "Flutter Apps",
        desc: "iOS & Android, one codebase, native feel",
        route: `${BASE}/services/flutter-apps`,
      },
      {
        icon: Layers,
        title: "React Native Apps",
        desc: "Cross platform apps with native UX",
        route: `${BASE}/services/react-native-apps`,
      },
    ],
  },
];
              ...
              {cat.items.map((item) => (
                ...
                >
                  ...
                  <div className="min-w-0">
                    <p className="text-[13px] font-semibold text-[#0A1628] leading-tight mb-0.5">
                      {item.title}
                    </p>
    ...
    <div className="border-t border-gray-100 bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-3 flex items-center justify-between">
        <span className="text-[12px] font-semibold text-[#374151]">
          15+ services &nbsp;|&nbsp; Results guaranteed
        </span>
        <a
          href={`${BASE}/services`}
          onClick={onClose}
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between h-[72px] px-4 md:px-6">
          {/* Logo */}
          <a href={BASE} className="shrink-0 flex items-center gap-2">
            <img
              src={logo}
              alt="Digital Aura"
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <a
              href={BASE}
              className="text-[14px] font-medium text-[#374151] hover:text-[#FF6B2B] transition-colors relative group whitespace-nowrap"
            >
              Home
            ...
            >
              <span className="text-[14px] font-medium text-[#374151] hover:text-[#FF6B2B] transition-colors cursor-default whitespace-nowrap">
                Company
              </span>
              <button
                onClick={() => setCompanyOpen((v) => !v)}
                className={`ml-0.5 p-1 transition-colors ${companyOpen ? "text-[#FF6B2B]" : "text-[#374151] hover:text-[#FF6B2B]"}`}
              >
                <ChevronDown
                  size={13}
              ...
              >
                <div
                  className="h-[3px]"
                  style={{ background: "linear-gradient(90deg, #FF6B2B, #7C3AED, #1A6FE8)" }}
                />
                {companyLinks.map((cl) => (
                  <a
                    key={cl.label}
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLElement).style.background = cl.bg;
                      (e.currentTarget as HTMLElement).style.color = cl.color;
                    }}
                    onMouseLeave={(e) => {
            ...
            {["Case Studies", "Awards", "Blogs", "Contact"].map((label) => {
              const href =
                label === "Case Studies"
                  ? `${BASE}/case-studies`
                  : label === "Awards"
          ...
          <div className="hidden lg:flex items-center gap-3 shrink-0">
            <a
              ...
              className="flex items-center gap-1.5 text-[15px] font-medium text-[#374151] hover:text-[#FF6B2B] transition-colors"
            >
      ...
      {/* Mobile overlay */}
      <div
        className={`fixed inset-0 z-[100] flex flex-col bg-white overflow-y-auto transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "translate-x-full"}`}
      >
        <div className="flex items-center justify-between px-6 py-6">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-gray-100 text-[#0A1628]"
          >
            <X size={24} />
          </button>
        </div>
        ...
        <div className="flex flex-col px-6 flex-1">
          <a
            href={BASE}
            onClick={() => setMobileOpen(false)}
            className="block text-2xl font-bold border-b border-gray-100 py-4 text-[#0A1628] hover:text-[#FF6B2B] transition-colors"
          >
            Home
          </a>
          ...
          <div>
            ...
            <div
              className={`overflow-hidden transition-all duration-200 ${mobileCompanyOpen ? "max-h-60 opacity-100" : "max-h-0 opacity-0"}`}
            >
          ...
          <div>
            ...
            <div
              className={`overflow-hidden transition-all duration-200 ${mobileServicesOpen ? "max-h-[600px] opacity-100" : "max-h-0 opacity-0"}`}
            >
              {megaCategories.map((cat) => (
